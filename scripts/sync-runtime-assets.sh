...
CANONICAL_WRITER_SRC="$ROOT_DIR/canonical_writer"
...
rsync -a --delete --exclude '__pycache__/' --exclude '*.pyc' "$CANONICAL_WRITER_SRC/" "$BUNDLE_DIR/canonical_writer/"
...
Launch examples:
  ...
  python3 -m pytest $BUNDLE_DIR/tests/test_runtime.py -v
