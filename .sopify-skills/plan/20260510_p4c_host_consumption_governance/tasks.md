...
- [ ] 1.1 审计 deep_verified 列各项"预期 required†"，逐项准备裁定清单
- [ ] 1.2 确定投影矩阵的格式、权威存放位置、消费方式

> **Gate**: 未完成 1.2，不进入 1.3-1.5。

- [ ] 1.3 基于 1.2 产出 FeatureId → 梯度投影矩阵
- [ ] 1.4 完成 deep_verified 各项最终 required / optional 裁定，消除 †
- [ ] 1.5 验证投影矩阵与 P4b.5 消费矩阵一致，无矛盾
